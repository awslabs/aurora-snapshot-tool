...
* **DestinationAccount** - the account(s) where you want snapshots to be copied to. this can be a single ID or a period separated list of IDs (ex. "123.456" becomes ["123","456"]).
